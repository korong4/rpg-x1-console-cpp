...
string p1_atacando[3] = {
    "   o   _/\\__",
    "  /|==-     ",
    "  / \\       "
};

string p2_atacando[3] = {
    "__/\\_   o   ",
    "    -==|\\   ",
    "      / \\   "
};

string p1_defendendo[3] = {
    "   o  [ ]",
    "  /|\\  | ",
    "  / \\    "
};

string p2_defendendo[3] = {
    "[ ]  o   ",
    "  |  /|\\ ",
    "    / \\  "
};

void desenharParadoLadoALado() {
    setColor(14);
    for (int i=0;i<3;i++) {
        cout << p1_parado[i]
             << "        "  
...
void desenharDefesaLadoALado() {
    setColor(14);
    for (int i=0;i<3;i++) {
        cout << p1_defendendo[i]
             << "   "
             << p2_defendendo[i]
             << '\n';
    }
